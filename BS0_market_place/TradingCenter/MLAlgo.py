...
class BuildRelations:
    ...
    def make_software_rel(self):
        ...
        for first in range(len(inv_lis) - 1):
            st = ""
            for first_fea in m.software_featurers.objects.filter(
                manager_id=inv_lis[first]
            ):
            ...
            for second in range(first, len(inv_lis)):
                st = ""
                for second_fea in m.software_featurers.objects.filter(
                    manager_id=inv_lis[second]
                ):
                ...
                if self.rel <= self.relation_value(first_lis, second_lis):
                    m.software_relations.objects.create(
                        first=inv_lis[first], second=inv_lis[second]
                    )
    ...
    def make_inventory_rel(self):
        ...
        for first in range(len(inv_lis) - 1):
            st = ""
            for first_fea in m.inventory_items_featurers.objects.filter(
                manager_id=inv_lis[first]
            ):
                st += first_fea.description + " "
            st += inv_lis[first].description + " "
            ...
            for second in range(first, len(inv_lis)):
                st = ""
                for second_fea in m.inventory_items_featurers.objects.filter(
                    manager_id=inv_lis[second]
                ):
                    st += second_fea.description + " "
            st += inv_lis[second].description + " "
            ...
            if self.rel <= self.relation_value(first_lis, second_lis):
                m.inventory_relations.objects.create(
                    first=inv_lis[first], second=inv_lis[second]
                )
    ...
    def make_services_rel(self):
        ...
        for first in range(len(inv_lis) - 1):
            st = ""
            for first_fea in m.service_featurers.objects.filter(
                manager_id=inv_lis[first]
            ):
                st += first_fea.description + " "
            st += inv_lis[first].description + " "
            ...
            for second in range(first, len(inv_lis)):
                st = ""
                for second_fea in m.service_featurers.objects.filter(
                    manager_id=inv_lis[second]
                ):
                    st += second_fea.description + " "
                st += inv_lis[second].description + " "
                ...
                second_lis = self.remove_junk(st)
            if self.rel <= self.relation_value(first_lis, second_lis):
                m.service_relations.objects.create(
                    first=inv_lis[first], second=inv_lis[second]
                )
