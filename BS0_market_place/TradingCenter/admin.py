...
class InventoryOrder(ModelAdmin):
    ...
    list_filter = [
        "manager_id__brands_product__brand_sector__commit_allowed",
        "is_commited_by_customer",
        "is_commited_by_owner",
        "is_commited_by_admin",
        "is_active",
    ]
...
class ServiceOrder(ModelAdmin):
    ...
    list_filter = [
        "request_id__service_id__brands_product__brand_sector__commit_allowed",
        "is_commited_by_customer",
        "is_commited_by_owner",
        "is_commited_by_admin",
        "is_active",
