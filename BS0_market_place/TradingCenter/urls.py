...
urlpatterns = [
    ...
    path(
        "brand/update/<int:pk>", v.BrandUpdateView.as_view(success_url="/market_page/")
    ),
    ...
    path(
        "services/list/detail/delete/portfolio/<int:serv_id>/<int:port_id>",
        v.delete_portfolio,
    ),
    path(
        "inventory/update/<int:pk>",
        v.InventoryManagerUpdateView.as_view(success_url="/market_page/"),
    ),
    path(
        "software/update/<int:pk>",
        v.SofwareManagerUpdateView.as_view(success_url="/market_page/"),
    ),
    path(
        "service/update/<int:pk>",
        v.ServiceManagerUpdateView.as_view(success_url="/market_page/"),
    ),
    ...
    path(
        "brand/cart/complete/detail/<int:pk>", v.BrandsCompletCartDetailView.as_view()
    ),
    path(
        "service/order/detail/cust/<int:pk>", v.ServiceOrderDetailViewByCart.as_view()
    ),
    path(
        "service/order/detail/own/<int:pk>", v.ServiceOrderDetailViewByOwner.as_view()
    ),
    ...
    path(
        "owner/order/inventory/simple/commit/<int:pk>", v.inventory_owner_simple_commit
    ),
    ...
    path(
        "otp/<int:amount>/<int:bill>/<int:phone_number>/<str:username>/<str:email>/<str:password>/",
        v.one_time_password_form,
    ),
